    ...
    return (
      <div className="h-screen w-64 bg-gray-900 text-white flex flex-col justify-between p-4">
        ...
        <nav className="mt-8 space-y-2">
          <a href="/dashboard/list" className="flex items-center space-x-3 px-4 py-2 bg-gray-800 rounded-lg">
          ...
          <a href="/dashboard/card" className="flex items-center space-x-3 px-4 py-2 hover:bg-gray-700 rounded-lg">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
